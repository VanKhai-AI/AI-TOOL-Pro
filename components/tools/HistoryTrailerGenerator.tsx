...
const HistoryTrailerGenerator: React.FC = () => {
    const tool = AI_TOOLS.find(t => t.id === 'history-trailer')!;
    const toolId = 'history-trailer';
...
export default HistoryTrailerGenerator;